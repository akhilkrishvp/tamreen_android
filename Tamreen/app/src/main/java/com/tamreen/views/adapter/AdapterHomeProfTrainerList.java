...
public class AdapterHomeProfTrainerList extends RecyclerView.Adapter<AdapterHomeProfTrainerList.ViewHolder> {
    ...
    public AdapterHomeProfTrainerList(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.list_item_home_pro_trainer, parent, false);
